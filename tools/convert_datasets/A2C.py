...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert A2C annotations to TrainIds')
    parser.add_argument('--A2C_path',default='/home/server4090/lyx/data/shenzhen_heart/model_data/A4C/train', help='A2C data path')
...
def main():
    args = parse_args()
    A2C_path = args.A2C_path
    out_dir = args.out_dir if args.out_dir else A2C_path
    mmcv.mkdir_or_exist(out_dir)

    gt_dir = osp.join(A2C_path, args.gt_dir)
