...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert A4C annotations to TrainIds')
    parser.add_argument('--A4C_path',default='/home/server4090/lyx/data/shenzhen_heart/model_data/A3C/train_orign/' ,help='A4C data path')
...
def main():
    args = parse_args()
    A4C_path = args.A4C_path
    out_dir = args.out_dir if args.out_dir else A4C_path
    mmcv.mkdir_or_exist(out_dir)

    gt_dir = osp.join(A4C_path, args.gt_dir)
