...
def parse_args():
    ...
    parser.add_argument('--gta_path', default='/home/server3090/lyx/GTA5',  help='gta data path')
    parser.add_argument('--gt-dir', default='labels', type=str)
    parser.add_argument('-o', '--out-dir', default='/home/server3090/lyx/GTA5', help='output path')
    parser.add_argument(
