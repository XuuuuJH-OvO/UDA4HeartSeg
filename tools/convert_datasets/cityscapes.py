...
def parse_args():
    ...
    parser.add_argument('--cityscapes_path', default='/home/server4090/lyx/data/cityscapes' ,help='cityscapes data path')
    parser.add_argument('--gt-dir', default='gtFine', type=str)
    parser.add_argument('-o', '--out-dir',default='/home/server4090/lyx/data/cityscapes' ,help='output path')
    parser.add_argument(
