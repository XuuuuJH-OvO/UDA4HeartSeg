...
data = dict(
    ...
    train=dict(
        ...
        target=dict(
            type='A4CDataset',
            data_root='/home/server4090/lyx/data/CAMUS_A4C/train/',  #'/home/server4090/lyx/data/shenzhen_heart/model_data/A2C/train/', #'/home/server4090/lyx/data/CAMUS_A4C/train/'
            img_dir='images',         #'images',
            ann_dir='labels',
            pipeline=A4C_train_pipeline)),
    val=dict(
        type='A4CDataset',
        data_root='/home/server4090/lyx/data/CAMUS_A4C/val/', #'/home/server4090/lyx/data/shenzhen_heart/model_data/A2C/test/' #'/home/server4090/lyx/data/CAMUS_A2C/val/'
        img_dir='images',
        ann_dir='labels',
        pipeline=test_pipeline),
    test=dict(
        type='A4CDataset',
        data_root='/home/server4090/lyx/data/CAMUS_A4C/val/', #'/home/server4090/lyx/data/shenzhen_heart/model_data/A2C/test/'
        img_dir='images',
        ann_dir='labels',
        pipeline=test_pipeline))
