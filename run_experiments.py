...
# ---------------------------------------------------------------
# Modifications: Change process name and other fixes
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--config',
        default=None,  #'configs/_base_/A2C_segmentation_daformer_mitb5.py',
        # default='configs/_base_/A2C_to_A4C_SePiCo.py',  #A2C_segmentation_daformer_mitb5.py
        # default='configs/_base_/A2C_to_A4C_SePiCo.py', A2C_to_A4C_SePiCo.py'
    ...
    if args.exp is not None:
        setproctitle.setproctitle(f'SePiCo EXP: {args.exp}')
        ...
        for i, cfg in enumerate(cfgs):
            if args.debug:
                ...
                cfg['evaluation'] = dict(interval=4000, metric='mDice')
                if 'dacs' in cfg['name']:
